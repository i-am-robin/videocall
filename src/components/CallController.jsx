...
function CallController() {
  return (
    <div className="bg-white-prymary bg-opacity-20  w-fit fixed left-1/2 bottom-5 -translate-x-1/2 rounded-full px-3 py-2 flex gap-10 items-center justify-between">
